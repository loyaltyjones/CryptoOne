...
function TetherUSD() {
  return (
    <div>
        ...
        Tether also issues tokens pegged to the euro, the offshore Chinese yuan, the Mexican peso, and gold, none with more than a fraction of the market cap of its U.S. dollar-pegged USDT tokens.456
        <p>Source: https://www.investopedia.com/terms/t/tether-usdt.asp</p>
        </p>
