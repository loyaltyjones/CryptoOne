...
function Ethereum() {
  return (
    <div>
        ...
        <p id='pEth' className='pCoin'>Ethereum is a decentralized blockchain with smart contract functionality. Ether (Abbreviation: ETH;[a]) is the native cryptocurrency of the platform. Among cryptocurrencies, ether is second only to bitcoin in market capitalization.[2][3] It is open-source software.
        ...
        <p> Source: https://en.wikipedia.org/wiki/Ethereum</p> 
        </p>        
    </div>
  )
}
