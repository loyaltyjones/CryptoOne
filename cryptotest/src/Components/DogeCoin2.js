...
function DogeCoin2() {
  return (
    <div>
        ...
        <p id='pDoge' className='pCoin'>For most of its existence, Dogecoin was generally considered to be an amusing “memecoin” beloved by its community — but with relatively little value. That changed in 2021, as Dogecoin became one of the ten biggest cryptocurrencies by market cap — with a total value that has topped $20 billion, even though each individual coin is worth pennies (see the current price). 
        ...
        <p>Source: https://www.coinbase.com/learn/crypto-basics/what-is-dogecoin</p>
        </p>
