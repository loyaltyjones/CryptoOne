...
function Usdc() {
  return (
    <div>
        ...
        <p id='pUsdc' className='pCoin'>USD Coin (USDC) is an asset backed stablecoin whose value is pegged to the U.S. Dollar (USD). 
 ...
 <p>Source: https://www.kraken.com/learn/what-is-usd-coin-usdc</p>
 </p>
